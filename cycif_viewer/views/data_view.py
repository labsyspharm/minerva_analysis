...
def upload_gates():
    ...
    save_path = Path(os.path.join(os.getcwd())) / "cycif_viewer" / "static" / "data" / datasource
...
def get_gating_csv_values():
    datasource = request.args.get('datasource')
    file_path = Path(os.path.join(os.getcwd())) / "cycif_viewer" / "static" / "data" / datasource / 'uploaded_gates.csv'
