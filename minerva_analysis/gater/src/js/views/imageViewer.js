...
class ImageViewer {
    ...
    constructor(config, imgMetadata, numericData, eventHandler) {
        ...
        const viewer_config = {
            id: "openseadragon",
            prefixUrl: "/gater/external/openseadragon-bin-2.4.0/openseadragon-flat-toolbar-icons-master/images/",
        ...
        seaGL.vShader = "/gater/src/shaders/vert.glsl";
        seaGL.fShader = "/gater/src/shaders/frag.glsl";
