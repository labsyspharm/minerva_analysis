// https://github.com/johnwalley/d3-simple-slider v1.10.1 Copyright 2020 John Walley
...
}(this, (function (exports, d3Transition, d3Axis, d3Array, d3Scale, d3Selection, d3Dispatch, d3Drag, d3Ease) { 'use strict';
...
function adaptListener(listener) {
  return function (a, b) {
    if (a && a.target) {
      ...
      // d3@v5
      listener.call(this, d3Selection.event, a);
    }
  };
}
